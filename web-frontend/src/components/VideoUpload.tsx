...
const VideoUpload: React.FC<Props> = ({ history, addPrediction, clearHistory }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      addPrediction(result.prediction, 'video');
    } catch (err) {
      console.error(err);
      setError('Failed to analyze video. Please ensure the backend is running.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="two-column-layout">
      ...
      <div className="input-column">
        <div className="glass-panel">
          <h2 style={{ marginBottom: '1.5rem', fontFamily: 'Outfit, sans-serif' }}>Video Input</h2>
          {!preview ? (
            <div 
            ...
            >
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '0.5rem', fontWeight: 600 }}>Upload a Video</h3>
          ...
          {file && (
            ...
            >
              {loading ? (
                <><Loader2 className="loader-spinner" /> Analyzing Video...</>
              ) : (
